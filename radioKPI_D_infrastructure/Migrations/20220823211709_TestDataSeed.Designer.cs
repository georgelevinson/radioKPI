...
namespace radioKPI_D_infrastructure.Migrations
{
    ...
    [Migration("20220823211709_TestDataSeed")]
            ...
            modelBuilder.Entity("radioKPI_D_infrastructure.Entities.Episode", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 2,
                            Description = "Music pod",
                            StatusId = 4
                        },
                        new
                        {
                            Id = 3,
                            Description = "Something with BIKES",
                            StatusId = 1
                        });
                });
            ...
            modelBuilder.Entity("radioKPI_D_infrastructure.Entities.GuestInfo", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            GuestDetails = "Junior year student at System Analysis Institute at KPI.",
                            JobTitlesOrSpecializations = "Engineer",
                            PlacesOfWorkOrStudy = "KPI",
                        ...
                        new
                        {
                            Id = 2,
                            CreatedOn = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            GuestDetails = "Officer of the Armed Forces of Ukraine.",
                            JobTitlesOrSpecializations = "Captain",
                            PlacesOfWorkOrStudy = "AFU",
                            UpdatedOn = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = 3,
                            CreatedOn = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            GuestDetails = "Jazz drummer at Phronesis.",
                            JobTitlesOrSpecializations = "Drummer",
                            PlacesOfWorkOrStudy = "Phronesis",
                            UpdatedOn = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        });
                });
            ...
            modelBuilder.Entity("radioKPI_D_infrastructure.Entities.Proposal", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedOn = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Description = "Engineering at KPI, robotics, AI",
                            GuestId = 1,
                            OrgNotes = "Free on weekends after 13:00",
                            UpdatedOn = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = 2,
                            CreatedOn = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Description = "Jazz music, art of improvisation, performer's community.",
                            GuestId = 2,
                            OrgNotes = "Only available on Saturday Sep.10 from 15:30 to 17:00",
                            UpdatedOn = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        });
                });
            ...
            modelBuilder.Entity("radioKPI_D_infrastructure.Entities.Session", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedOn = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            RecordingDate = new DateTime(2022, 9, 10, 13, 0, 0, 0, DateTimeKind.Unspecified),
                            UpdatedOn = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        });
                });
            ...
            modelBuilder.Entity("radioKPI_D_infrastructure.Entities.Sufflere", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedOn = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DataJson = "JSON string with sufflere data for podcast with AI and robotics engineering student form KPI.",
                            ProposalId = 1,
                            UpdatedOn = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = 2,
                            CreatedOn = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DataJson = "JSON string with sufflere data for podcast with Phronesis drummer.",
                            ProposalId = 2,
                            UpdatedOn = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        });
                });
